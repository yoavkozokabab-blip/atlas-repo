...
gh release create v1.0.1 `
  ...
  --notes "Atlas 1.0.1 (Windows). Unsigned build; SHA256 and build commit in the release notes."
# Print the asset URL:
...
## Future releases
Bump `PRODUCT_VERSION`, rebuild, create a new tag, upload, update `ATLAS_INSTALLER_URL`.
