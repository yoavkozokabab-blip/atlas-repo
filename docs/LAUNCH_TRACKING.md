...
**Supabase (production):** run `websites/jarvis-landing/supabase/migrations/0003_0004_0005_analytics_bundle.sql` in SQL Editor. Without grants (`0005`), events fail to insert and the dashboard shows zeros.
