"""Format ask results into benchmark Atlas context packets."""
...
def format_atlas_packet(result: Dict[str, Any]) -> str:
    """Assemble the deterministic offline Atlas context string."""
    lines = [
