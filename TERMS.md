...
2. **License.** Atlas is proprietary (see `LICENSE`). We grant a limited, revocable,
   ...
   engineering or redistribution except where the law requires. **[LAWYER REVIEW]**

3. **Acceptable use.** No unlawful use, no infringement of others' rights, no attempts to
   disrupt, overload, or attack the service or other users.

4. **AI / code-output disclaimer.** Atlas surfaces and ranks repository context. Any
   resulting code, suggestions, rankings, or analysis are **informational, may be
   incorrect, and must be reviewed by you** before use. You are solely responsible for
   what you build, run, or ship. **[LAWYER REVIEW]**

5. **No warranty.** Atlas is provided "AS IS" and "AS AVAILABLE", without warranties of
   any kind, express or implied. **[LAWYER REVIEW]**

6. **Limitation of liability.** To the maximum extent permitted by law, we are not liable
   for indirect, incidental, special, or consequential damages. Aggregate liability is
   capped at the greater of fees you paid in the prior 12 months or US$100.
   **[LAWYER REVIEW]**
