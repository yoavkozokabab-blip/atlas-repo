...
const faqs = [
  ...
  ["Is the installer safe?", "Download Atlas from useatlas.dev. Windows SmartScreen may warn on first run for new or unsigned apps; confirm the source before continuing."]
] as const;
