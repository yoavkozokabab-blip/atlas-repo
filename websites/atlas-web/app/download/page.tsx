...
import { CURRENT_WINDOWS_RELEASE, GITHUB_RELEASE_URL, releaseSizeLabel } from "../_config";
    ...
    >
      ...
      >
        <div className="dl-card">
          ...
          <p className="dl-meta">
            {CURRENT_WINDOWS_RELEASE.filename} · v{CURRENT_WINDOWS_RELEASE.version} ·{" "}
            {releaseSizeLabel()} · Windows 10 / 11
          </p>
          <p className="dl-meta" style={{ marginTop: 12, wordBreak: "break-all" }}>
            SHA256: <code>{CURRENT_WINDOWS_RELEASE.sha256}</code>
          </p>
