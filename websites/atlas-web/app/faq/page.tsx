...
const faqs = [
  ...
  ["Is it free?", "Yes. Free is $0 with unlimited time, repository scanning, the local dependency graph, MCP integration, Ask Atlas, Debug, Impact analysis, Plan Change and the dependency map. Pro is $19/month with a 7-day free trial."],
