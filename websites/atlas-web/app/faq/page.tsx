...
const faqs = [
  ...
  ["Which model answers my questions?", "None. Atlas does not call any LLM — Impact, Debug, and Plan Change are deterministic lookups against the local index, and your coding agent retrieves cited context over MCP. Your agent brings its own model and decides what context to send to it."],
  ...
  ["What is included in Free?", "Free includes the core local app, local scan, MCP context retrieval, Impact, Debug, Plan Change, and Map."],
