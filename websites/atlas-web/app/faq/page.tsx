...
const faqs = [
  ...
  ["Which model answers my questions?", "None. Atlas does not call any LLM — Impact, Debug, and Plan Change are deterministic lookups against the local index. Your coding agent brings its own model and decides what context to send to it."],
  ...
  ["What is included in Free?", "Free includes the core local app, local scan, MCP, Impact, Debug, Plan Change, and Map. Ask Atlas (repository Q&A) is under development and is not included in this beta."],
