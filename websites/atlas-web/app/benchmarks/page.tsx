...
export const metadata: Metadata = {
  ...
  description: "Transparent, reproducible Atlas measurements: sample-repo indexing time, context-retrieval latency, and retrieval quality on a 50-scenario suite.",
};
      ...
      <section className="section" style={{ borderTop: "none", paddingTop: 8 }}>
        <div className="container prose" style={{ maxWidth: 820 }}>
          ...
          <ul>
            ...
            <li><b>Context-retrieval latency:</b> 1–30 ms per query after indexing. Results are deterministic lookups against the local index — there is no model call in the loop.</li>
          </ul>
