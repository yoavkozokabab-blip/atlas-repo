...
def merge_graphs(py_graph: Dict[str, Any], js_graph: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    merged: Dict[str, Any] = {
        ...
        "atlas_timed_out": bool(py_graph.get("atlas_timed_out")) or bool(js_graph.get("atlas_timed_out")),
        "atlas_partial": bool(py_graph.get("atlas_partial")) or bool(js_graph.get("atlas_partial")),
...
def build_scan_graph(
    ...
    *,
    ...
    graph["atlas_graph_build"] = {
        **plan,
        "elapsed_sec": elapsed,
        "timed_out": bool(graph.get("atlas_timed_out")),
        "partial": bool(graph.get("atlas_partial")),
