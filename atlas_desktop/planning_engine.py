...
def plan_change(request: str, ctx: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from atlas_desktop.reliability import (
...
def investigate_symptom(symptom: str, ctx: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from atlas_desktop.reliability import confidence_cap_for_scan as _cap_fn, graph_health_label as _ghl_inv
    ...
    from atlas_desktop.reliability import calibrate_confidence_cap as _calib_inv
