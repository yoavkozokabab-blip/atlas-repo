...
def _delta_lines_build(plan: Dict[str, Any], *, goal: str = "") -> List[str]:
    ...
    """
    from atlas_desktop.atlas_export import _dedupe_paths, _concept_label, _evidence_lines
...
def _delta_lines_investigate(plan: Dict[str, Any], *, goal: str = "") -> List[str]:
    ...
    """
    from atlas_desktop.atlas_export import _dedupe_paths, _evidence_lines
