...
def test_installer_generated_version_matches_product():
    path = ROOT / "packaging" / "installer" / "generated_version.iss"
    if not path.is_file():
        pytest.skip("generated_version.iss is generated by packaging/installer/installer_build.ps1")
    iss = path.read_text(encoding="utf-8")
