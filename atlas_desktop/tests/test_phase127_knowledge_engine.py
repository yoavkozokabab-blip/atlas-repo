...
from atlas_desktop import api, domain_knowledge as dk
...
from atlas_desktop.atlas_knowledge.retrieval import RETRIEVAL_BLOCKLIST, RetrievalPolicy
from atlas_desktop.atlas_knowledge.validator import validate_catalog
...
def test_catalog_validates_core_concepts():
    ...
    for cid in ("ema", "jwt", "authentication", "stripe_billing"):
        ...
        from atlas_desktop.atlas_knowledge.schema import validate_concept
