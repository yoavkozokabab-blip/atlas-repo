...
from atlas_desktop import session_handoff as sh
...
def _events():
    return {
        ...
        "changed_files": ["atlas_desktop/session_handoff.py"],
        "commands_run": ["py -3 -m pytest atlas_desktop/tests/test_session_handoff_memory.py"],
