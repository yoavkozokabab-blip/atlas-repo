...
class TestRootCauseEvidence:
    ...
    def test_noisy_module_demoted(self):
        ...
        from atlas_desktop.planning_engine import _is_noisy_module, _root_cause_evidence_score
    ...
    def test_root_cause_evidence_score_demotes_stdlib(self):
        ...
        from atlas_desktop.planning_engine import _root_cause_evidence_score
