...
from atlas_desktop.reliability import confidence_cap_for_scan, graph_health_label
...
def analyze_impact(target: str, state: Dict[str, Any], *, summary: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    try:
        from atlas_desktop.reliability import calibrate_confidence_cap as _calib
