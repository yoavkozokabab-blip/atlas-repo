...
// The previous screen heartbeat emitted repeatedly during one normal session.
// Keep the navigation hook to preserve UI behavior, but do not treat render or
// dwell time as remote product analytics.
const desktopEngagement = { viewChanged() {} };
