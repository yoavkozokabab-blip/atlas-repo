...
## 1. actions/service_actions.py:21 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-9e2a0a696a71', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'actions/service_actions.py:21'}, 'strength': 'E2', 'subject': {'file': 'actions/service_actions.py', 'line': 21, 'qualname': 'EnableAutostartAction.execute', 'slot': 'branch'}}

MISSING PROOF OBLIGATIONS
  - exact contract violation atom
  - promotion-grade feasible path witness
  - repository test or runtime reproduction
  - evidence promotion gate disabled
...
- labels: useful_advisory
- confidence: 4 -> 4
- usefulness: 3 -> 0
- confirmation clarity: 3 -> 4
- verification evidence: helped
- status: refuted atoms=1

## 2. actions/website_actions.py:43 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-b70424821e34', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'actions/website_actions.py:43'}, 'strength': 'E2', 'subject': {'file': 'actions/website_actions.py', 'line': 43, 'qualname': '_entry_from_params', 'slot': 'branch'}}
...
## 3. alpha/session_log.py:40 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-8ee376691f44', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'alpha/session_log.py:40'}, 'strength': 'E2', 'subject': {'file': 'alpha/session_log.py', 'line': 40, 'qualname': '_infer_provider', 'slot': 'branch'}}
...
## 4. assistant/investigation_scheduler.py:161 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-7977dc02ee55', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'assistant/investigation_scheduler.py:161'}, 'strength': 'E2', 'subject': {'file': 'assistant/investigation_scheduler.py', 'line': 161, 'qualname': 'scheduler_tick', 'slot': 'branch'}}
...
## 5. backups/jarvis_patches/20260526_121610_95ec3bbe/services__live_paper_engine.py:960 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-c2d05b10d988', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'backups/jarvis_patches/20260526_121610_95ec3bbe/services__live_paper_engine.py:960'}, 'strength': 'E2', 'subject': {'file': 'backups/jarvis_patches/20260526_121610_95ec3bbe/services__live_paper_engine.py', 'line': 960, 'qualname': '_safe_reconcile_adapter_positions', 'slot': 'branch'}}
...
## 6. brain/patch_command_phrases.py:118 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-dd2908e4403d', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'brain/patch_command_phrases.py:118'}, 'strength': 'E2', 'subject': {'file': 'brain/patch_command_phrases.py', 'line': 118, 'qualname': 'is_patch_workflow_phrase', 'slot': 'branch'}}
...
## 7. builder_core/gitutil.py:70 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-6b5ce100110d', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'builder_core/gitutil.py:70'}, 'strength': 'E2', 'subject': {'file': 'builder_core/gitutil.py', 'line': 70, 'qualname': 'churn_counts', 'slot': 'branch'}}
...
## 8. desktop/control_runtime.py:208 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-4870ddabfeff', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'desktop/control_runtime.py:208'}, 'strength': 'E2', 'subject': {'file': 'desktop/control_runtime.py', 'line': 208, 'qualname': 'extract_button_label', 'slot': 'branch'}}
...
## 9. investigation/replay_cache.py:12 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-928e039f7162', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'investigation/replay_cache.py:12'}, 'strength': 'E2', 'subject': {'file': 'investigation/replay_cache.py', 'line': 12, 'qualname': 'get_cache', 'slot': 'branch'}}
...
## 10. runtime/dashboard_health.py:27 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-fe9e22ceea57', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'runtime/dashboard_health.py:27'}, 'strength': 'E2', 'subject': {'file': 'runtime/dashboard_health.py', 'line': 27, 'qualname': '_load', 'slot': 'branch'}}
...
## 11. tests/test_phase41_6_tts_runtime.py:162 (blocked)
...
SUPPORTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': False, 'unresolved_reasons': ['interprocedural_gate_not_met']}, 'claim': 'path.partial', 'evidence_id': 'VE-01956d67d2f8', 'evidence_type': 'path_feasibility_evidence', 'limitations': ['Static path witness only; no runtime trace imported.'], 'polarity': 'limits', 'provenance': {'path_status': 'partial', 'source_kind': 'repository_ast', 'source_ref': 'tests/test_phase41_6_tts_runtime.py:162'}, 'strength': 'E2', 'subject': {'file': 'tests/test_phase41_6_tts_runtime.py', 'line': 162, 'qualname': 'test_streaming_retry_blocking_on_failure', 'slot': 'path'}}

MISSING PROOF OBLIGATIONS
  - exact contract violation atom
  - promotion-grade feasible path witness
  - repository test or runtime reproduction
  - resolved caller dereference without null-check
  - evidence promotion gate disabled

BLOCKERS
  - interprocedural_promotion_gate_not_met
  - missing_explicit_return_obligation
...
- confirmation clarity: 3 -> 4
- verification evidence: helped
- status: blocked atoms=1

## 12. tests/test_phase71_tool_use.py:127 (blocked)
...
SUPPORTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': False, 'unresolved_reasons': ['interprocedural_gate_not_met']}, 'claim': 'path.partial', 'evidence_id': 'VE-5e5b5fcf3a42', 'evidence_type': 'path_feasibility_evidence', 'limitations': ['Static path witness only; no runtime trace imported.'], 'polarity': 'limits', 'provenance': {'path_status': 'partial', 'source_kind': 'repository_ast', 'source_ref': 'tests/test_phase71_tool_use.py:127'}, 'strength': 'E2', 'subject': {'file': 'tests/test_phase71_tool_use.py', 'line': 127, 'qualname': 'test_approval_required_for_every_external_step', 'slot': 'path'}}
...
## 13. tests/test_tts_failure_visibility.py:35 (blocked)
...
SUPPORTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': False, 'unresolved_reasons': ['interprocedural_gate_not_met']}, 'claim': 'path.partial', 'evidence_id': 'VE-8141c98e83f5', 'evidence_type': 'path_feasibility_evidence', 'limitations': ['Static path witness only; no runtime trace imported.'], 'polarity': 'limits', 'provenance': {'path_status': 'partial', 'source_kind': 'repository_ast', 'source_ref': 'tests/test_tts_failure_visibility.py:35'}, 'strength': 'E2', 'subject': {'file': 'tests/test_tts_failure_visibility.py', 'line': 35, 'qualname': 'test_async_tts_failure_recorded', 'slot': 'path'}}
...
## 14. tests_tmp/pytest_temp/pytest-of-babi2/pytest-341/test_cli_ask_returns_bug_findi0/fake_repo/python_programs/off_by_one.py:1 (blocked)
...
SUPPORTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': False, 'unresolved_reasons': ['interprocedural_gate_not_met']}, 'claim': 'path.partial', 'evidence_id': 'VE-5fbac2b3365a', 'evidence_type': 'path_feasibility_evidence', 'limitations': ['Static path witness only; no runtime trace imported.'], 'polarity': 'limits', 'provenance': {'path_status': 'partial', 'source_kind': 'repository_ast', 'source_ref': 'tests_tmp/pytest_temp/pytest-of-babi2/pytest-341/test_cli_ask_returns_bug_findi0/fake_repo/python_programs/off_by_one.py:1'}, 'strength': 'E2', 'subject': {'file': 'tests_tmp/pytest_temp/pytest-of-babi2/pytest-341/test_cli_ask_returns_bug_findi0/fake_repo/python_programs/off_by_one.py', 'line': 1, 'qualname': 'last_item', 'slot': 'path'}}
...
## 15. ui/console_modal.py:150 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-536ceeeb0d53', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'ui/console_modal.py:150'}, 'strength': 'E2', 'subject': {'file': 'ui/console_modal.py', 'line': 150, 'qualname': '_run_modal_with_input_fn', 'slot': 'branch'}}
...
## 16. voice/providers/elevenlabs_websocket.py:30 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-3934b298b83e', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'voice/providers/elevenlabs_websocket.py:30'}, 'strength': 'E2', 'subject': {'file': 'voice/providers/elevenlabs_websocket.py', 'line': 30, 'qualname': 'get_elevenlabs_ws_session', 'slot': 'branch'}}
...
## 17. voice/pyttsx3_completion.py:333 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-0d280f777ed2', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'voice/pyttsx3_completion.py:333'}, 'strength': 'E2', 'subject': {'file': 'voice/pyttsx3_completion.py', 'line': 333, 'qualname': '_WorkerState.snapshot', 'slot': 'branch'}}
...
## 18. voice/tts_pyttsx3.py:40 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-b9c3feb6cdf7', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'voice/tts_pyttsx3.py:40'}, 'strength': 'E2', 'subject': {'file': 'voice/tts_pyttsx3.py', 'line': 40, 'qualname': '_get_engine', 'slot': 'branch'}}
...
## 19. voice/voice_calibration.py:58 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-34a75c59c97d', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'voice/voice_calibration.py:58'}, 'strength': 'E2', 'subject': {'file': 'voice/voice_calibration.py', 'line': 58, 'qualname': '_load_payload', 'slot': 'branch'}}
...
## 20. website_audit/inspector.py:42 (refuted)
...
REFUTING EVIDENCE
  - {'binding': {'resolution_scope': 'intra_file', 'resolved': True, 'unresolved_reasons': []}, 'claim': 'path.no_implicit_none_exit', 'evidence_id': 'VE-3f94c7b3c1e6', 'evidence_type': 'path_feasibility_evidence', 'limitations': [], 'polarity': 'refutes', 'provenance': {'source_kind': 'repository_ast', 'source_ref': 'website_audit/inspector.py:42'}, 'strength': 'E2', 'subject': {'file': 'website_audit/inspector.py', 'line': 42, 'qualname': '_read', 'slot': 'branch'}}
