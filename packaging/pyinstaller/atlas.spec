...
version_resource = str(_version_file) if _version_file.is_file() else None
...
exe = EXE(
    ...
    icon=icon,
    # Windows version resource, generated by build_atlas_exe.ps1 from
    # PRODUCT_VERSION. Without it Atlas.exe reports FileVersion 0.0.0.0 and a
    # blank Properties -> Details tab, which reads as suspicious on an
    # already-unsigned binary.
