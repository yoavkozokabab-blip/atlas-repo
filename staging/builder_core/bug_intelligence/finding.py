...
class Finding:
    ...
    confirmed_defect_classification: Optional[Dict[str, Any]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.contract_review is not None:
            out["contract_review"] = dict(self.contract_review)
        if self.verification_evidence is not None:
            out["verification_evidence"] = dict(self.verification_evidence)
        if self.confirmed_defect_classification is not None:
            out["confirmed_defect_classification"] = dict(self.confirmed_defect_classification)
        return out
