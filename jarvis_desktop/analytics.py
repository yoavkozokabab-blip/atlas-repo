...
# Phase 116E investigation diagnostics (opt-in: JARVIS_ANALYTICS_DIAG=1).
_DIAG_LOGGER = logging.getLogger("jarvis.analytics.write_diag")
_PHASE116E_DIAG = os.environ.get("JARVIS_ANALYTICS_DIAG", "0").strip().lower() in {
    "1",
    "true",
    "yes",
    "on",
