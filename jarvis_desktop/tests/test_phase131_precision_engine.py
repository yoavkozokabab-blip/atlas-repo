...
from jarvis_desktop.evidence_engine.precision_engine import rank_files
from jarvis_desktop.evidence_engine.implementation_detector import DetectionResult, detect_ema
from jarvis_desktop.evidence_engine import EvidenceStore, build_evidence_store, analyze_concept
...
def test_precision_tiers_cap_file_count():
    from jarvis_desktop.evidence_engine.precision_engine import TIER1_MAX, TIER2_MAX
