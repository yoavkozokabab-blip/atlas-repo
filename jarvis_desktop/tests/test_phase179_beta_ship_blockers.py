...
from jarvis_desktop import api, first_impression as fi, planning_engine, product_info, server
...
def test_atlas_desktop_data_env_alias(tmp_path, monkeypatch):
    ...
    from jarvis_desktop.data_paths import reset_desktop_data_dir_cache, desktop_data_dir
